...
const AchievementCard: React.FC<AchievementCardProps> = ({ 
  ...
  return (
    <AnimatedSection 
      ...
      delay={delay}
      className={`rounded-xl border p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md ${color}`}
    >
      <div className="mb-4 flex items-center justify-between">
        <div className="rounded-full bg-school-primary/10 p-2 text-school-primary">
          {icon}
        </div>
...
const StudentAchievements: React.FC = () => {
  const achievements = [
    ...
    },
    {
      ...
      count: "150+",
      color: "bg-gradient-to-br from-white to-orange-50",
      delay: 100
    },
    {
  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-24">
      <div className="absolute -right-32 top-0 h-64 w-64 rounded-full bg-school-primary/5 blur-3xl"></div>
      <div className="absolute -left-32 bottom-0 h-64 w-64 rounded-full bg-school-secondary/5 blur-3xl"></div>
      ...
      <div className="container relative px-4">
        ...
        <div className="mt-12 text-center">
          <Button asChild variant="outline" className="rounded-full border-school-primary text-school-primary hover:bg-school-primary/10 hover:text-school-primary">
