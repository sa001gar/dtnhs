  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        school: "bg-gradient-to-r from-school-primary to-school-secondary text-white hover:from-school-primary/90 hover:to-school-secondary/90 relative overflow-hidden shadow-md",
        perspective: "bg-gradient-to-r from-school-primary to-school-secondary text-white transform hover:-translate-y-1 hover:shadow-lg transition-all duration-300 relative overflow-hidden",
      },
      size: {
