      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="bg-gray-200 h-[250px] rounded flex items-center justify-center">
                <p className="text-gray-500">Map placeholder - Google Maps iframe would go here</p>
              </div>
            </CardContent>
          </Card>
        </div>
