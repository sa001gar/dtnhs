...
const AdmissionPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-muted/20">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-school-primary to-school-primary/80 text-white py-16 md:py-24 overflow-hidden">
        {/* Decorative Elements */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center rounded-full bg-white/20 px-3 py-1 text-sm mb-6">
              <School className="mr-2 h-4 w-4" />
              <span>Admissions {academicYear}</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Join Our Educational Journey</h1>
            <p className="text-lg md:text-xl text-white/90 mb-8">
              Durgapur Tarak Nath High School welcomes aspiring students to be part of our legacy of excellence in education
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-school-primary hover:bg-white/90 shadow-lg">
            ...
            <AnimatedSection animation="fade-in-up">
              ...
              <Card className="mb-12 border-2 border-school-primary/20 shadow-md">
                ...
                <CardContent className="pt-6">
                  ...
                  <Alert className="mt-6 border-amber-200 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-800">
